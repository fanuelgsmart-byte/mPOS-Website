...
export function LiquidMetalButton({ label = "Log In", onClick, viewMode = "text", variant = "default" }: LiquidMetalButtonProps) {
        ...
        if (shaderRef.current) {
          ...
          shaderMount.current = new ShaderMount(
            ...
            liquidMetalFragmentShader,
            {
              u_repetition: 4,
              u_softness: 0.5,
              u_shiftRed: variant === "red" ? 0.8 : 0.3,
              u_shiftBlue: variant === "red" ? 0.0 : 0.3,
              u_distortion: 0,
              u_contour: 0,
              u_angle: 45,
              u_scale: 8,
