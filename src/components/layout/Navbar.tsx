          ...
          <nav className="hidden md:flex items-center gap-1 mx-6">
            ...
            <div ref={dropdownRef} style={{ position: "relative" }}>
              <button
                ...
                onMouseLeave={() => {
                  // keep open if hovering dropdown panel
                }}
              >
                Solution
                <ChevronDown
                      ...
                      {["Profit", "Sale", "Balance", "Stock"].map((label, i) => (
                        <span
                          ...
                          style={{
                            ...
                            fontSize: "0.7rem",
                            fontWeight: 600,
                            background: ["#FEE2E2", "#D1FAE5", "#DBEAFE", "#EDE9FE"][i],
                            color: ["#991B1B", "#065F46", "#1D4ED8", "#5B21B6"][i],
                            whiteSpace: "nowrap",
                          }}
                        >
                          {label}
              ...
              <div>
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 500,
                    color: "#374151",
                    background: mobileSolutionsOpen ? "#F9FAFB" : "transparent",
                    border: "none",
                    cursor: "pointer",
                    textAlign: "left",
                  }}
